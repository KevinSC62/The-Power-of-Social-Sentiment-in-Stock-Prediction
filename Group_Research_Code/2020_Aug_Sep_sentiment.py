...
input_csv_path = "c:\\Users\\a9106\\Desktop\\research_paper_code\\Covid-19 Twitter Dataset (Aug-Sep 2020).csv"


# Read the CSV file
df = pd.read_csv('C:\\Users\\a9106\\Desktop\\research_paper_code\\Covid-19 Twitter Dataset (Aug-Sep 2020).csv', encoding='ISO-8859-1', dtype={12: str}, low_memory=False)
...
df.to_csv("c:\\Users\\a9106\\Desktop\\research_paper_code\\2020_Aug_Sep_sentiment.csv", index=False)
